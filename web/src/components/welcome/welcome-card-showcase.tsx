...
const cardTypes = [
  {
    ...
    price: 'Free',
    features: ['NFC Payments', 'QR Scanning', 'Refill Options', 'Transaction History'],
  ...
  },
  {
    ...
    price: '$50',
    features: ['Accept NFC/QR', 'POS Integration', 'Sales Analytics', 'No Withdrawal Fees'],
  ...
  },
  {
    ...
    price: '$75+',
    features: ['Card Activation', 'Commission Tracking', 'Zone Management', 'Bulk Operations'],
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-subheading opacity-80 max-w-3xl mx-auto">
            Get the perfect card for your needs. From personal payments to business operations.
          </p>
        </motion.div>
