...
import { AdvancedPaymentsHub } from '@/components/mobile/AdvancedPaymentsHub';
import { 
  MobileButton, 
  MobileCard, 
  MobileModal, 
...
export default function MobileDemoPage() {
  ...
  // Demo states
  const [currentView, setCurrentView] = useState<'features' | 'wallet' | 'auth' | 'advanced'>('features');
