              ...
              <Card>
                <CardHeader>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Multi-step form with real-time balance validation and
            ...
            <TabsContent value="qr-payment" className="space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Generate and process QR codes with backend API integration
            ...
            <TabsContent value="pos-interface" className="space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Point of sale interface for merchants with QR code
