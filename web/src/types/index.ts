...
// ===== USER TYPES =====
export type UserRole = 'client' | 'merchant' | 'distributor' | 'diaspora' | 'admin' | 'super_admin';
...
// ===== TRANSACTION TYPES =====
export type TransactionType = 'send' | 'receive' | 'refill' | 'withdraw' | 'payment' | 'commission';
export type TransactionStatus = 'pending' | 'completed' | 'failed' | 'cancelled';
export type PaymentMethod = 'card' | 'nfc' | 'qr' | 'apple_pay' | 'google_pay' | 'bank_transfer';
...
export interface FormField {
  name: string;
  label: string;
  type: 'text' | 'email' | 'password' | 'number' | 'select' | 'textarea' | 'phone';
  placeholder?: string;
  required?: boolean;
  validation?: any;
