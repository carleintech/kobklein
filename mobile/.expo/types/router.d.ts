...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(tabs)/` | `/(tabs)` | `/(tabs)/interactive-charts` | `/interactive-charts` | `/(tabs)/profile` | `/profile` | `/(tabs)/transactions` | `/transactions` | `/(tabs)/wallet` | `/wallet` | `/auth/signin` | `/auth/signup` | `/qr-scanner`;
  // prettier-ignore
